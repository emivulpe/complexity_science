...
class PredatorPreyModel(object):
    def __init__(self, predators=5, prey=10, prey_growth_rate=4.0, prey_death_rate=1.0, predator_death_rate=2.0, predator_growth_rate=0.075, harvesting_reward=1.0, harvesting_cost=1.0, harvesting_effort=0.999):
        """
    ...
    def prey_change(self, prey, predators):
        ...
        return self.prey_growth_rate * prey * (1 - prey) - self.prey_death_rate * prey * predators
    ...
    def predator_change(self, prey, predators):
        ...
        # Calculate the rate of population change
        return self.predator_growth_rate * predators * prey


    def calculate_improved_euler(self, delta_time=0.02, iterations=100):
        """
...
def main():
    gc = PredatorPreyModel(prey = 80, predators = 115, prey_growth_rate=0.2, prey_death_rate=0.02, predator_growth_rate=0.35)
    dynamics = gc.calculate_improved_euler()
    prey_populations = dynamics['prey']
    predator_populations = dynamics['predator']
    print prey_populations
